...
class AuthMangerApi {
  ...
  static Future<ApiResponse<UserModel>> getProfile() async {
    try {
      ...
      if (token == null || token.isEmpty) return ApiResponse(success: false, message: "please login first");
      ...
      if (response.statusCode == 200) {
        ...
        return ApiResponse<UserModel>.fromJson(jsonResponse, (data) => UserModel.fromJson(data));
