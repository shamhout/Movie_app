            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Text(appLocalizations.screenShots,
                      style: AppStyle.roboto24BoldWhite),
                ),
                SizedBox(height: height * 0.01),
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(appLocalizations.similar,
                      style: AppStyle.roboto24BoldWhite),
                ),
                SizedBox(height: height * 0.015),
                FutureBuilder(
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(appLocalizations.summary,
                      style: AppStyle.roboto24BoldWhite),
                ),
                SizedBox(height: height * 0.01),
                Text(
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(appLocalizations.cast,
                      style: AppStyle.roboto24BoldWhite),
                ),
                SizedBox(height: height * 0.01),
                Column(
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(appLocalizations.genres,
                      style: AppStyle.roboto24BoldWhite),
                ),
